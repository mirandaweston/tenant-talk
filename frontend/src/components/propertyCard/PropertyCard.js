  ...
  return (
    <Link to={`/property/${propertyId}`}>
      <li
        ...
        className="col-span-1 flex w-full items-center justify-between space-x-6 divide-y divide-gray-200 bg-white p-6 shadow transition-colors hover:bg-gray-50 sm:rounded-lg "
      >
